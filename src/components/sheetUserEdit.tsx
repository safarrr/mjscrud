...
function SheetUserEdit({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (!result.success) {
      ...
      setErrors({});
      console.log("Valid update data:", result.data);
    }
    try {
      await axios.patch("/api/user/" + initialData.id, result.data, {
        headers: {
  ...
  return (
    <Sheet open={openSheet} onOpenChange={setOpenSheet}>
      <SheetContent>
        ...
        <form onSubmit={onSubmit} className="space-y-6 overflow-y-auto p-5">
          <Card>
